...
public class CreateOpportunitytc_14withQualificationTest{
...
@Test
	...
	
	{
		...
		/*Step 8: navigate to sales stage and select prospecting*/
		
		WebElement ele = driver.findElement(By.xpath("//select[@name='sales_stage']"));
